...
import kr.sprouts.framework.oauth.resource.applications.member.dto.request.MemberUpdateRequest;
import kr.sprouts.framework.oauth.resource.applications.member.dto.request.MemberVerificationRequest;
import kr.sprouts.framework.oauth.resource.applications.member.dto.response.MemberResponse;
import kr.sprouts.framework.oauth.resource.applications.member.dto.response.MemberVerificationResponse;
import kr.sprouts.framework.oauth.resource.applications.member.service.MemberCommandService;
import kr.sprouts.framework.oauth.resource.applications.member.service.MemberQueryService;
